...
const ACTIONS = [
  ...
  {
    step: 4,
    key: 'club-career-backfill-500',
    label: 'Backfill Club Career 500',
    desc: 'Force fetch lại detail cho 500 record thiếu lịch sử CLB',
    path: '/enrichment/fifaaddict/backfill-club-career',
    body: { batchSize: 50, delayMs: 600, limit: 500, onlyMissing: true },
    confirm: true,
  },
  {
    step: 5,
    key: 'club-career-backfill-all',
    label: 'Backfill Club Career All Missing',
    desc: 'Force fetch lại detail cho toàn bộ record còn thiếu lịch sử CLB',
    path: '/enrichment/fifaaddict/backfill-club-career',
    body: { batchSize: 50, delayMs: 600, limit: 0, onlyMissing: true },
    confirm: true,
  },
  {
    step: null,
