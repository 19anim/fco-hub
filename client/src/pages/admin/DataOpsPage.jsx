...
const ACTIONS = [
  ...
  {
    step: 4,
    key: 'club-career-backfill-missing',
    label: 'Backfill Club Career Missing',
    desc: 'Fetch detail cho toàn bộ record chưa có lịch sử CLB, phù hợp sau khi discover thêm cầu thủ/mùa giải mới',
  ...
  {
    step: 5,
    key: 'club-career-backfill-full',
    label: 'Backfill Club Career Full Refresh',
